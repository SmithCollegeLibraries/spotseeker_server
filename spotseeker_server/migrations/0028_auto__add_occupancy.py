...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Occupancy'
        db.create_table('spotseeker_server_occupancy', (
    ...
    def backwards(self, orm):
        # Deleting model 'Occupancy'
        db.delete_table('spotseeker_server_occupancy')
    ...
    models = {
        ...
        'spotseeker_server.itemextendedinfo': {
            'Meta': {'unique_together': "(('item', 'key'),)", 'object_name': 'ItemExtendedInfo'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'spotseeker_server.occupancy': {
            'Meta': {'object_name': 'Occupancy'},
